...
const patchEmployeeById = async (osuId, body) => {
  ...
  try {
    ...
    await connection.execute(contrib.patchEmployeeById(), {
      ...
      i9Date: attributes.i9.date,
      i9ExpireDate: attributes.i9.expireDate,
      i9formInd: attributes.i9.formInd,
      w4IrsOptCode1: attributes.w4.irsOptCode1,
      w4IrsOptCode4: attributes.w4.irsOptCode4,
      w4IrsAmount1: attributes.w4.irsAmount1,
      w4IrsAmount2: attributes.w4.irsAmount2,
      w4IrsAmount3: attributes.w4.irsAmount3,
      w4IrsAmount4: attributes.w4.irsAmount4,
      w4IrsAmount5: attributes.w4.irsAmount5,
      w4IrsAmount6: attributes.w4.irsAmount6,
      w4IrsEffectiveDate: attributes.w4.irsEffectiveDate,
      w4IrsStatus: attributes.w4.irsStatus,
      w4OrOptCode1: attributes.w4.orOptCode1,
      w4OrOptCode2: attributes.w4.orOptCode2,
      w4OrAmount1: attributes.w4.orAmount1,
      w4OrEffectiveDate: attributes.w4.orEffectiveDate,
      w4OrStatus: attributes.w4.orStatus,
    });
    const lines = await getLine(connection, []);
